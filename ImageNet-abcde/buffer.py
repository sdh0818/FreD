...
if __name__ == '__main__':
    ...
    parser.add_argument('--pix_init', type=str, default='noise', choices=["noise", "real"], help='noise/real: initialize synthetic images from random noise or randomly sampled real images.')
    ...
    parser.add_argument('--save_path', type=str, default='results_buffer', help='path to save results')
    ...
    parser.add_argument('--space', type=str, default='p', choices=['p', 'z', 'w', 'w+', 'wp', 'g'], help='[ p | z | w | w+ ]')
