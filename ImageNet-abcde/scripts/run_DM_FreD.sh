...
TAG=""
FLAG="${dst}_${res}_${ipc}ipc_${net}D${depth}#DM_FreD_${msz_per_channel}_${batch_syn}#${Iteration}_${lr_freq}_${mom_freq}#${TAG}"

CUDA_VISIBLE_DEVICES=${cuda_id} python3.8 main_DM_FreD.py \
--dataset ${dst} --res ${res} \
